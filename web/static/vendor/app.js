...
var _user$project$App$extractText = function (maybeWord) {
	var _p0 = maybeWord;
	if (_p0.ctor === 'Just') {
		return _p0._0;
	} else {
...
var _user$project$App$updateCurrentTypedWords = F2(
...
var _user$project$App$getWordStyle = function (word) {
...
var _user$project$App$wordsToHTML = function (words) {
...
var _user$project$App$arrayToString = function (array) {
	return A3(
...
var _user$project$App$createWordWithUpdatedStatus = F3(
...
var _user$project$App$randomInts = F2(
	function (num, seed) {
		return A2(
				...
				A2(
					...
					A2(
						...
						A2(
							...
							0,
							_elm_lang$core$Array$length(_user$project$App$hardcodedWordRepository) - 1)),
					seed)));
	});
var _user$project$App$lowerCaseZ = 122;
var _user$project$App$upperCaseA = 65;
var _user$project$App$spaceKey = 32;
var _user$project$App$Word = F3(
	function (a, b, c) {
...
var _user$project$App$resolveWordStatus = F2(
	function (originalText, typedTextArray) {
		var typedTextString = _user$project$App$arrayToString(typedTextArray);
		return _elm_lang$core$Native_Utils.eq(originalText, typedTextString) ? _user$project$App$TypedCorrectly : _user$project$App$TypedIncorrectly;
	});
var _user$project$App$Unevaluated = {ctor: 'Unevaluated'};
var _user$project$App$extractWord = function (maybeWord) {
	var _p2 = maybeWord;
	if (_p2.ctor === 'Just') {
		return _p2._0;
	} else {
		return {text: 'OOOPS', wordStatus: _user$project$App$Unevaluated, typedText: ''};
	}
};
var _user$project$App$updateWordStatus = function (model) {
	var currentWord = A2(
		_elm_lang$core$Debug$log,
		'updateWordStatus extractWord = ',
		_user$project$App$extractWord(
	...
	var currentWordStatus = A2(
		...
		A2(_user$project$App$resolveWordStatus, currentWord.text, model.currentTypedChars));
	var updatedWord = A2(
		_elm_lang$core$Debug$log,
		'updateWordStatus updatedWord',
		A3(_user$project$App$createWordWithUpdatedStatus, currentWord, model.currentTypedChars, currentWordStatus));
	return {
		ctor: '_Tuple2',
		_0: _elm_lang$core$Native_Utils.update(
			model,
...
var _user$project$App$createWord = function (wordText) {
	return {text: wordText, wordStatus: _user$project$App$Unevaluated, typedText: ''};
};
var _user$project$App$randomWords = F2(
	function (num, seed) {
		return A2(
			_elm_lang$core$List$map,
			_user$project$App$createWord,
			A2(
				_elm_lang$core$List$map,
				_user$project$App$extractText,
				A2(
					_elm_lang$core$List$map,
					function (i) {
						return A2(_elm_lang$core$Array$get, i, _user$project$App$hardcodedWordRepository);
					},
					A2(_user$project$App$randomInts, num, seed))));
	});
...
var _user$project$App$subscriptions = function (model) {
	return _elm_lang$keyboard$Keyboard$presses(_user$project$App$KeyTyped);
};
var _user$project$App$TimeForInitialSeed = function (a) {
	return {ctor: 'TimeForInitialSeed', _0: a};
};
var _user$project$App$init = {
	ctor: '_Tuple2',
	_0: {
		wordsRepository: _user$project$App$hardcodedWordRepository,
	...
	_1: A3(
		...
		function (time) {
			return _user$project$App$TimeForInitialSeed(time);
		},
		_elm_lang$core$Time$now)
};
